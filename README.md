...
3. **Motor de Vocabularios y Jerarquías**: Mapeo de códigos fuente a conceptos estándar (`'Maps to'`) y navegación de jerarquías clínicas mediante clausura transitiva (`CONCEPT_ANCESTOR`).
...
Puede abrir directamente el cuaderno interactivo haciendo clic en el siguiente enlace o en la insignia:
